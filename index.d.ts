declare module "react-native-rsa-native" {
  ...
  namespace RSA {
    ...
    export function sign64WithAlgorithm(
      data: string,
      key: string,
      signature?: TypeCrypto
    ): Promise<string>;
    ...
    export function verifyWithAlgorithm(
      data: string,
      secretToVerify: string,
      key: string,
      signature?: TypeCrypto
    ): Promise<boolean>;
    export function verify64(
      data: string,
      secretToVerify: string,
      key: string
    ): Promise<boolean>;
    export function verify64WithAlgorithm(
      data: string,
      secretToVerify: string,
      key: string,
      signature?: TypeCrypto
  ...
  namespace RSAKeychain {
    ...
    export function generateCSRWithEC(
      cn: String,
      keyTag: string,
      keySize: number
    ...
    export function getPublicKeyDER(
      keyTag: string
    ): Promise<string | undefined>;
    export function getPublicKeyRSA(
      keyTag: string
    ): Promise<string | undefined>;
    export function deletePrivateKey(keyTag: string): Promise<boolean>;
    export const SHA256withRSA: string;
